...
public class CollectionBook {
    ...
    static ArrayList<ContactList> contactDetails1 = new ArrayList<>(); //Create an ArrayList for Address book1
    static ArrayList<ContactList> contactDetails2 = new ArrayList<>(); //Create an ArrayList for Address Book2
    static HashMap<String, ArrayList> book = new HashMap<>();//Creating HashMap
    private static ContactList[] contactDetails;
    ...
    public static void displayContacts() {
        ...
        for (ContactList contactsDetailsInfo : contactDetails1) {
            System.out.println(contactsDetailsInfo);
        }
        System.out.printf("Address Book: %s ", bookName[1]).println();
        for (ContactList contactsDetailsInfo : contactDetails2) {
            System.out.println(contactsDetailsInfo);
        }
    }
