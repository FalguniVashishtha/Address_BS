...
public class Operation {
    //Creating array List
    static ArrayList<ContactList> contactsDetails = new ArrayList();
    ...
    private static List<ContactList> SearchInMultipleBook(String name) {
        for (Map.Entry<String, ArrayList<ContactList>> entry : hashmap.entrySet()) {
            for (ContactList contacts1 : entry.getValue()) {
    ...
    public static List<ContactList> countFromSame_City_State(String name){
        int count=0;
        for (Map.Entry<String, ArrayList<ContactList>> entry : hashmap.entrySet()){
            for (ContactList v:entry.getValue()){
    ...
    public static void sortContact(HashMap<String, ArrayList<ContactList>> multipleAddressBook) {
...
//                checking the duplicate name.
    ...
    public void displayContacts(ArrayList<ContactList> contactsDetails) {
        for (ContactList contactsDetailsValue : Operation.contactsDetails) {
    ...
    public static void displayAddressBook() {
        for (Map.Entry<String, ArrayList<ContactList>> entry : hashmap.entrySet())
            for (ContactList v : entry.getValue()) {
                ...
                System.out.println(v.getFirstName() + "\t" + v.getLastName() + "\t" + v.getEmail() + "\t" + v.getContactNo() + "\t" + v.getAddress() + "\t" + v.getCity() + "\t" + v.getState() + "\t" + v.getZip());
            }
    }
    /*
     ...
     */
    public void editDetails(ArrayList<ContactList> contactsDetails1) {
        System.out.println("Enter the first name you want to edit ");
        String searchFirstName = sc.next();
        // taking for each loop
        for (ContactList contact : Operation.contactsDetails) {
    ...
    public void deleteContact(ArrayList<ContactList> contactsDetails) {
        System.out.println("Enter First Name for which you want to delete contact: ");
        String firstname = sc.next();

        Iterator<ContactList> removeContact = Operation.contactsDetails.iterator();
    ...
    public static void menuChoose(Operation operations, ArrayList<ContactList> contactsDetails) {
